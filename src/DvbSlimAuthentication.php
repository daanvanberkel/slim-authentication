...
class DvbSlimAuthentication {
	...
	private function __construct(array $config = array()) {
		...
		$default_config = array(
			...
			"login_template"              => '<form method="post"><input type="email" name="dvb_email" placeholder="Email" /><input type="password" name="dvb_password" placeholder="Password" /><input type="text" name="dvb_two_factor" placeholder="Two factory code" /><button type="submit" name="dvb_submit" value="dvb_login">Login</button></form>',
